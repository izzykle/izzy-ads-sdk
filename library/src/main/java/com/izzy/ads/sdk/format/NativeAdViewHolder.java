package com.izzy.ads.sdk.format;

import static com.izzy.ads.sdk.util.Constant.ADMOB;
import static com.izzy.ads.sdk.util.Constant.AD_STATUS_ON;
import static com.izzy.ads.sdk.util.Constant.APPLOVIN;
import static com.izzy.ads.sdk.util.Constant.APPLOVIN_MAX;
import static com.izzy.ads.sdk.util.Constant.GOOGLE_AD_MANAGER;
import static com.izzy.ads.sdk.util.Constant.NONE;
import static com.izzy.ads.sdk.util.Constant.STARTAPP;
...
import com.izzy.ads.sdk.R;
import com.izzy.ads.sdk.util.AdManagerTemplateView;
import com.izzy.ads.sdk.util.Constant;
import com.izzy.ads.sdk.util.NativeTemplateStyle;
import com.izzy.ads.sdk.util.TemplateView;
import com.izzy.ads.sdk.util.Tools;
...
public class NativeAdViewHolder extends RecyclerView.ViewHolder {
    ...
    final LinearLayout nativeAdViewContainer;

    //AdMob
    final MediaView mediaView;
    final TemplateView admobNativeAd;
    final LinearLayout admobNativeBackground;

    //Ad Manager
    final MediaView adManagerMediaView;
    final AdManagerTemplateView adManagerNativeAd;
    final LinearLayout adManagerNativeBackground;

    //StartApp
    final View startappNativeAd;
    final ImageView startappNativeImage;
    final ImageView startappNativeIcon;
    final TextView startappNativeTitle;
    final TextView startappNativeDescription;
    final Button startappNativeButton;
    final LinearLayout startappNativeBackground;

    //AppLovin
    final FrameLayout applovinNativeAd;
